...
cd ${projDir}
nextflow run /home/rad/users/gaurav/projects/workflows/nfchipseq --input ${projDir}/foxp1FkoPkf1oe_SampleSheet.csv --genome GRCm38 --narrow_peak --single_end -name foxp1FkoPkf1oe1
